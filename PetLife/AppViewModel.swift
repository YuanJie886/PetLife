...
class AppViewModel: ObservableObject {
    ...
    func loadData() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
            self.hotFeeds = [
                FeedPost(content: "今天的阳光真好，带布丁去公园撒欢啦！☀️🐶", likes: 128, comments: 12, timeAgo: "10分钟前", imageUrl: "photo.fill"),
                FeedPost(content: "新买的猫粮到了，主子闻到味道就跑过来了！", likes: 45, comments: 3, timeAgo: "2小时前", imageUrl: "photo.artframe"),
